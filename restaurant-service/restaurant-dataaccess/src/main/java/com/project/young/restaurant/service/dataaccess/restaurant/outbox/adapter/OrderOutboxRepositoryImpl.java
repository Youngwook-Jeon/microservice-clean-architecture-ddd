package com.project.young.restaurant.service.dataaccess.restaurant.outbox.adapter;

import com.project.young.outbox.OutboxStatus;
import com.project.young.restaurant.service.dataaccess.restaurant.outbox.exception.OrderOutboxNotFoundException;
import com.project.young.restaurant.service.dataaccess.restaurant.outbox.mapper.OrderOutboxDataAccessMapper;
import com.project.young.restaurant.service.dataaccess.restaurant.outbox.repository.OrderOutboxJpaRepository;
import com.project.young.restaurant.service.domain.outbox.model.OrderOutboxMessage;
import com.project.young.restaurant.service.domain.ports.output.repository.OrderOutboxRepository;
